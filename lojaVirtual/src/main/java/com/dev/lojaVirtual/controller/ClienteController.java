...
public class ClienteController {
	...
	public ModelAndView cadastrar(ClienteModel cliente) {
	...
	public ModelAndView salvar(@Valid ClienteModel cliente, BindingResult result) {
		...
		return cadastrar(new ClienteModel());
	}
